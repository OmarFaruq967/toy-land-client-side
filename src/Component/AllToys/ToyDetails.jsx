      ...
      <div className="my-14 mx-20 ">
          ...
          <div className="card lg:card-side bg-base-100 shadow-xl px-10 py-10">
            ...
            <div className="card-body">
              ...
              <p className="font-medium">Seller Email: <span className='font-normal'>{data.email}</span> </p>
              </div>
              ...
              <p className="font-medium">Available Quantity: {data.availableQuantity}</p>
              <p className="font-medium">Description: <span className='font-normal'>{data.detailDescription}</span></p>
